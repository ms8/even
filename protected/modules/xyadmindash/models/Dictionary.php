...
class Dictionary extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('code, parencode', 'length', 'max'=>50),
			array('name', 'length', 'max'=>200),
			array('type', 'length', 'max'=>10),
			array('typename', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, code, name, type, typename, parencode', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('parencode',$this->parencode,true);
