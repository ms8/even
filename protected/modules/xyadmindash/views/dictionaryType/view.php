...
//	array('label'=>'Update DictionaryType', 'url'=>array('update', 'id'=>$model->id)),
//	array('label'=>'Delete DictionaryType', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
    ...
    <div style="float: right;margin: 10px 350px 0 0px;">
        ...
        <div style="margin: 10px 0 10px 0;padding-left: 200px">
            ...
            <button id="create" class="btn"
                    onclick="window.location.href='?r=xyadmindash/dictionarytype/update&id=<?php echo $model->id?>'">
                更新字典类型
            </button>
        </div>
