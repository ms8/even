  ...
  <!--
    ...
    <h3 class="title-article">
        ...
        <div style="float: right">
            <span class="timestamp">2013-02-06 22:40</span>
        ...
        <div style="clear: both">
            <div class="edit" >
                ...
                <a href="#" onclick="confirmDelete(this);return false;">删除</a>
                <span class="pipe">|</span>
                <a href="#">公开</a>
                <span class="pipe">|</span>
                <a href="#" onclick="confirmDelete(this);return false;">仅好友可见</a>
                <span class="pipe">|</span>
                <a href="#">私密</a>
            </div>
        </div>
            ...
            <table id="reader">
                <tr>
                    <td style="padding: 0 10px;">
                        <div style="width: 50px;height: 50px;"><img src="upload/grava.png"> </div>
                        <div style="width: 50px;height: 15px;text-align: center">李明华</div>
                    </td>
                    <td>
                        <div style="width: 50px;height: 50px;"><img src="upload/favicon.png"> </div>
                        <div style="width: 50px;height: 15px;text-align: center">陈晓丹</div>
                    </td>
                    <td style="padding: 0 10px;">
                        <div style="width: 50px;height: 50px;"><img src="upload/grava.png"> </div>
                        <div style="width: 50px;height: 15px;text-align: center">李明华</div>
