        ...
        <div class="wrap">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div >
                            <input id="realname" value="" type="text"  class="input-large" required placeholder="必填项">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div >
                            <input id="phone" value=""type="text" class="input-large" required placeholder="必填项">
                        </div>
                    </div>
                        ...
                        <div >
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><input id="dorm" type="text" class="input-mini"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
